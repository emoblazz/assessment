...
<header class="main-header">
		...
		include('dbcon.php');
		$id=$_SESSION['sid'];
		$query=mysqli_query($con,"select * from class natural join enrol where stud_id='$id'")or die(mysqli_error());
	      ...
	      <li class="dropdown notifications-menu">
              ...
              <li class="dropdown notifications-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                   ...
                   $query1=mysqli_query($con,"select * from t_log natural join teacher natural join enrol where stud_id='$sid' order by log_id desc")or die(mysqli_error());
		      ...
		      while ($row1=mysqli_fetch_array($query1))
		      {
                   ...
                   ?>
                      <li>
                        <a href="#">
                          <i class="fa fa-users text-aqua"></i><?php echo $row1['t_salut']." ".$row1['t_first']." ".$row1['t_last']." ".$row1['activity'];?>
                        </a>
                      </li>
                     <?php }?>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="../dist/img/<?php echo $_SESSION['spic'];?>" class="user-image" alt="User Image">
