	  ...
	  <div class="row" >
		...
		<div class="box box-primary">
		  <div class="box-body">
			<div class="row" style="background-color:<?php echo $rowhead['class_color'];?>;">
			  ...
			  <div class="col-md-10">
				...
				<h4><b>Attendance for <?php echo $term;?></b></h4>
			   </div><!--col-->
			 </div><!--row-->  
		  </div> <!-- Box body -->
		</div> <!-- Box box widget -->
	      ...
	      include('../dist/includes/dbcon.php');
		      ...
		      $cid=$_REQUEST['cid'];
		      $term=$_REQUEST['term'];
			  $query=mysqli_query($con,"select * from grade where class_id='$cid' and term='$term' and type='Attendance'")or die(mysqli_error());
			  $row1=mysqli_fetch_array($query);
			  $countat=mysqli_num_rows($query);
	  ?>
	  <!-- Custom Tabs -->
          <div class="nav-tabs-custom">
          <form method="post" action="at_save.php">
              <ul class="nav nav-tabs">
                 <li class="active"><a href="#tab_1" data-toggle="tab"><?php echo $term;?> Attendance</a></li>
                 <li><input type="number" class="form-control" name="total" placeholder="Total Attendance" value="<?php echo $row1['total'];?>"></li>
              </ul>
		    ...
		    <?php
			  ...
			  $query1=mysqli_query($con,"select * from enrol natural join student where enrol.class_id='$cid'")or die(mysqli_error());
				...
				while($row2=mysqli_fetch_array($query1))
				{
				  ...
				  $at=mysqli_query($con,"select * from grade where stud_id='$stud_id' and class_id='$cid' and term='$term' and type='Attendance'")or die(mysqli_error());
			...
			<div class="box-header with-border">
			  <div class="user-block">
			    ...
			    <div class="col-lg-3">
				<input type="number" class="form-control" name="score[]" placeholder="Present" value="<?php echo $rowat['score'];?>">
			    </div>
			  </div><!-- /.user-block -->
			</div><!-- /.box-header -->
