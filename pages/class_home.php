	  ...
	  <!-- Custom Tabs -->
		...
		//$aid=$_REQUEST['aid'];
	      ...
	      ?>
			...
			<div class="box-header with-border">
			  <div class="user-block">
				...
				<span class="username"><a href="#"><?php echo $row2['t_first']." ".$row2['t_last'];?></a>  
					<?php
					  $aid=$row2['assign_id'];
					    $query3=mysqli_query($con,"select class_name,assign_id,class_id from assign_class natural join class where class_id='$cid' and assign_id='$aid'")or die(mysqli_error());
						while($row1=mysqli_fetch_array($query3)){ 
						  $cid=$row1['class_id'];
						  echo " >> ";echo "<a href='view_class.php?cid=$cid'>".$row1['class_name']."</a>";}?>
				</span>
			...
			<div class="box-body">
			 <!-- post text -->
			  <h4><a href='class_assign.php?aid=<?php echo $aid;?>&cid=<?php echo $cid;?>'><?php echo $row2['assign_desc'];?></a></h4>
				...
				<a href="#" class="small-box-footer"> Submit <i class="fa fa-arrow-circle-right"></i></a>
                  ...
                  <div class="tab-pane" id="tab_2">
						<?php
							include('../dist/includes/dbcon.php');
							$cid=$_REQUEST['cid'];
							$query=mysqli_query($con,"select * from stud_assign natural join student natural join assign natural join assign_class where class_id='$cid' order by stud_assign.date_posted desc,stud_assign.time_posted desc")or die(mysqli_error());
