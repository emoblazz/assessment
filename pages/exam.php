	...
	<div class="row">
		...
		<div class="nav-tabs-custom">
		  <ul class="nav nav-tabs">
		    <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">Active Exam</a></li>
		    <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">Deactivated Exam</a></li>
		  ...
		  <div class="tab-content">
		    <div class="tab-pane active" id="tab_1">
				...
				$id=$_SESSION['id'];
				$query=mysqli_query($con,"select * from quiz natural join class_quiz natural join class where quiz.t_id='$id' and quiz_type='Exam' and class_stat='Active' and class_quiz_stat='Activated' order by quiz_date desc	")or die(mysqli_error());
				$quizcount=mysqli_num_rows($query);
				if ($quizcount<1){echo "<h3 class='text-red'>No Available Exam!</h3>";}
				else {
				  echo "
	...
	<div class="modal-content" style="height:450px;">
		...
		<form class="form-horizontal" method="post" action="class_quiz_update.php">
		    ...
		    <div class="form-group">
		      <label class="control-label col-lg-3" for="title">Exam Title</label>
			  ...
			  <input type="text" class="form-control" id="title" name="title" placeholder="Title of the Exam" value="<?php echo $row['quiz_title'];?>">  
		      </div>
		    </div> 
		    <div class="form-group">
		    ...
		    <div class="form-group">
		      <label class="control-label col-lg-3" for="status">Quiz Status</label>
		      <div class="col-lg-7">
		    ...
		    <div class="form-group">
			<label class="control-label col-lg-12" for="class">Assign to Class</label>
				  <?php
					$id=$_SESSION['id'];
	...
	<div class="modal-content" style="height:200px;">
		...
		<button type="button" class="btn btn-default" data-dismiss="modal" aria-hidden="true">No</button>
		    ...
		    <div class="tab-pane" id="tab_2">
			    ...
			    include('../dist/includes/dbcon.php');
			    $id=$_SESSION['id'];
			    $query=mysqli_query($con,"select * from quiz natural join class_quiz natural join class where quiz.t_id='$id' and quiz_type='Exam' and class_stat='Active' and class_quiz_stat='Deactivated'")or die(mysqli_error());
			    $quizcount=mysqli_num_rows($query);
			    if ($quizcount<1){echo "<h3 class='text-red'>No Available Exam!</h3>";}
			    else {
			      echo "
 ...
 <div id="removequiz<?php echo $row['class_quiz_id'];?>" class="modal fade in col-md-12" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:200px;">
         <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title">Remove Class Exam</h4>
         </div>
	 <div class="modal-body">
	    <form class="form-horizontal" method="post" action="class_quiz_update.php">
		<!-- Title -->
	    ...
	    <button type="submit" name="remove" class="btn btn-danger">Yes</button>
		    ...
		    <div class="tab-pane" id="tab_3">
			    ...
			    include('../dist/includes/dbcon.php');
			    $id=$_SESSION['id'];
			    $query=mysqli_query($con,"select * from quiz natural join class_quiz natural join class where quiz.t_id='$id' and quiz_type='Exam' and class_stat='Active' and class_quiz_stat=''")or die(mysqli_error());
			    $quizcount=mysqli_num_rows($query);
			    if ($quizcount<1){echo "<h3 class='text-red'>No Available Exam!</h3>";}
			    else {
			      echo "
	    ...
	    <button type="submit" name="remove" class="btn btn-danger">Yes</button>
		  ...
		  <div class="box-body">
			...
			<div class="controls">			
				...
				<div class="form-group">
				  <label for="title">Title of Test</label>
				  <input type="text" class="form-control" id="title" placeholder="Title of Test" name="title">
				</div>
