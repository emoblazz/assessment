    ...
    <div class="wrapper">
	  ...
	  <form method="post" action="submit.php">
	    ...
	    <i class="glyphicon glyphicon-flash"></i>
            Progress
            <a href="export2.php?cid=<?php echo $_REQUEST['cid'];?>&term=<?php echo $_REQUEST['term'];?>" class="btn btn-warning"><i class="glyphicon glyphicon-import"></i>Export</a>
            <button class="btn btn-primary"><i class="glyphicon glyphicon-import"></i>Submit Grades</button>		
          </h1>
	...
	<div class="row">
		 ...
		 <div class="box">
			...
			?>
                      ...
                      <input type="hidden" name="prelim[]" value="<?php echo $total;?>">
                      <input type="hidden" name="midterm[]" value="<?php echo $total2;?>">
                      <input type="hidden" name="endterm[]" value="<?php echo $total3;?>">
