	  ...
	  <div class="row">
		...
		<div class="box box-widget widget-user">
		  ...
		  <div class="widget-user-image">
		    <img class="img-circle" src="../dist/img/<?php echo $_SESSION['spic'];?>" alt="User Avatar">
		  </div>
		  <div class="box-footer">
		    <div class="row">
			  ...
			  $id=$_SESSION['sid'];
			    $query2=mysqli_query($con,"select * from student where stud_id='$id'")or die(mysqli_error());
			  ...
			  <form class="form-horizontal" method="post" action="personalinfo_update.php">
				...
				<div class="col-sm-10">
				  <input type="text" class="form-control" id="inputPassword3" placeholder="First Name" name="first" value="<?php echo $row1['stud_first'];?>" required>
				</div>
			      </div>
			      <div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Last Name</label>
				<div class="col-sm-10">
				  <input type="text" class="form-control" id="inputEmail3" placeholder="Last Name" name="last" value="<?php echo $row1['stud_last'];?>" required>
				</div>
			      </div>
			    </div><!-- /.box-body -->
			...
			<div class="box box-info">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				    <input type="text" class="form-control" id="inputEmail3" placeholder="Username" name="username" value="<?php echo $row1['stud_user'];?>" required>
				  </div>
				</div>
				<div class="form-group">
				  <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
				  <div class="col-sm-10"><input type="hidden" class="form-control" id="inputPassword3" name="pass1" value="<?php echo $row1['stud_pass'];?>">
			...
			<div class="col-md-6">
			  ...
			  <div class="box box-info">
				...
				<div class="form-group"><input type="hidden" class="form-control" id="pass1" name="oldpass" value="<?php echo $row1['stud_pass'];?>">
